...
> 36 |         throw new Error(`Searched item "${searchItem}" not found in results`);
  ...
  43 |             const text = (await item.textContent())?.trim().toLocaleLowerCase();
  44 |             console.log("----------------------------------------",text)
  45 |             console.log("----------------------------------------",searchItem.toLocaleLowerCase())
  46 |         if (text?.includes(searchItem.toLocaleLowerCase())) {
  47 |                 return true;
  48 |             }
  49 |         }
  50 |         return false;
